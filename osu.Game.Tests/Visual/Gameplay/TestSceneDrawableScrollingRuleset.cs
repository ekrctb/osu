...
namespace osu.Game.Tests.Visual.Gameplay
{
    public class TestSceneDrawableScrollingRuleset : OsuTestScene
    {
        ...
        public void TestHitObjectPooling()
        {
            ...
            AddSliderStep("time", 0, time_range * 10, 0, time => testClock.CurrentTime = time);
        }
        ...
        private class TestDrawableScrollingRuleset : DrawableScrollingRuleset<TestHitObject>
        {
            ...
            public override DrawableHitObject<TestHitObject> CreateDrawableRepresentation(TestHitObject h) =>
                h switch
                {
                    TestPooledHitObject p => null,
                    TestPooledParentHitObject p => null,
        ...
        {
            private Container<DrawableHitObject> container;
            public DrawableTestParentHitObject([CanBeNull] TestHitObject hitObject) : base(hitObject)
            {
        ...
        {
            public DrawableTestPooledParentHitObject() : base(null)
            {
